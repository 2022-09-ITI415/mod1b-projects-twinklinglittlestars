...
public class KProjectileLine : MonoBehaviour
{
        static public KProjectileLine S; // Singleton
        ...
        public void AddPoint()
        {
            ...
            if (points.Count == 0)
            {
                ...
                // to be defined- it adds an extra bit of line to aid aiming later
        ...
        void FixedUpdate()
        {
            if (poi == null)
            {
                ...
                {
                    if (FollowCam.POI.tag == "KirbyEdited") // changed projectile to kirbyedited
                    {
                        poi = FollowCam.POI;
                    }
                    else
